...
app.get('/api/health', (c) => {
  return c.json({ status: 'ok', version: '3.29.1' })
})
...
app.get('/', (c) => {
  return c.html(`
    ...
    <head>
        ...
        <title>Rosicatore v3.29.1 - Portfolio Tracker</title>
        ...
        <div class="container mx-auto px-4 py-6">
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-gray-400 mt-1">Portfolio Tracker Algorithm - v3.29.1</p>
                </div>
