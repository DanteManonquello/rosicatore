...
app.get('/api/health', (c) => {
  return c.json({ status: 'ok', version: '3.12.1' })
})
...
app.get('/', (c) => {
  return c.html(`
    ...
    <head>
        ...
        <title>Rosicatore v3.12.1 - Portfolio Tracker</title>
            ...
            <div class="p-6">
                ...
                <div class="mt-8 pt-8 border-t border-gray-700">
                    <div class="text-sm text-gray-400">
                        <div class="mb-2"><strong>Versione:</strong> 3.12.1</div>
        ...
        <div class="container mx-auto px-4 py-6">
            <div class="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p class="text-gray-400 mt-1">Portfolio Tracker Algorithm - v3.12.1</p>
                </div>
